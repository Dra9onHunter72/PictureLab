...
public class Picture extends SimplePicture 
{
  ...
  public void HunterFilter(int startRow, int startCol)
  {
	  Pixel fromPixel = null;
	  Pixel toPixel = null;
	  Picture Hunter = new Picture("Hunter.png");
	  Pixel [][] toPixels = this.getPixels2D(); //The base layer of the picture
	  Pixel [][] fromPixels = Hunter.getPixels2D(); //The layer we are adding to the picture.
	  int fromRow = 0;
